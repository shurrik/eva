...
public class AcessoriesAction extends
	...
	public String save(HttpServletRequest request, Acessories acessories) {
		...
		opLogService.createNew("上传附件", acessories.getFileName(), getCurrentUser(request));
	...
	public String delete(String ids, HttpServletRequest request) {
		opLogService.createNew("删除附件", "附件ID"+ids, getCurrentUser(request));
	...
	public HttpServletResponse wnloadit(String name, String partpath,
		...
		opLogService.createNew("下载附件", filename, getCurrentUser(request));
		return null;
	}
