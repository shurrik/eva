...
(function(window, $) {
	...
	window.ngGrid.i18n['fa'] = {
		ngAggregateLabel: '賲賵乇丿赖丕',
		ngGroupPanelDescription: '蹖讴 毓賳賵丕賳 爻鬲賵賳 丕蹖賳噩丕 乇丕 亘乇丿丕乇 賵 亘赖 诏乇賵赖蹖 丕夭 丌賳 爻鬲賵賳 亘蹖丕賳丿丕夭.',
		ngSearchPlaceHolder: '噩爻鬲噩賵...',
		ngMenuText: '丕賳鬲禺丕亘 爻鬲賵賳\u200c赖丕:',
		ngShowingItemsLabel: '賳賲丕蹖卮 賲賵乇丿赖丕:',
		ngTotalItemsLabel: '赖賲赖贁 賲賵乇丿赖丕:',
		ngSelectedItemsLabel: '賲賵乇丿赖丕蹖 丕賳鬲禺丕亘\u200c卮丿赖:',
		ngPageSizeLabel: '丕賳丿丕夭赖贁 氐賮丨赖:',
		ngPagerFirstTitle: '氐賮丨赖贁 丕賵賱',
		ngPagerNextTitle: '氐賮丨赖贁 亘毓丿',
		ngPagerPrevTitle: '氐賮丨赖贁 賯亘賱',
		ngPagerLastTitle: '丌禺乇蹖賳 氐賮丨赖'
	};
	...
	window.ngGrid.i18n['zh-cn'] = {
		...
		ngSearchPlaceHolder: '鎼灭储...',
		ngMenuText: '鏁版嵁鍒嗙粍涓庨€夋嫨鍒楋细',
		ngShowingItemsLabel: '褰揿墠鏄剧ず鏉＄洰锛?,
		ngTotalItemsLabel: '鏉＄洰镐绘暟锛?,
		ngSelectedItemsLabel: '阃変腑鏉＄洰锛?,
		ngPageSizeLabel: '姣忛〉鏄剧ず鏁帮细',
		ngPagerFirstTitle: '锲炲埌棣栭〉',
		ngPagerNextTitle: '涓嬩竴椤?,
		ngPagerPrevTitle: '涓娄竴椤?,
		ngPagerLastTitle: '鍓嶅线灏鹃〉'
	};

	window.ngGrid.i18n['zh-tw'] = {
		ngAggregateLabel: '绛?,
		ngGroupPanelDescription: '鎷栨媺琛ㄩ牠鍒版铏曚互阃茶鍒嗙祫',
		ngSearchPlaceHolder: '鎼滃皨...',
		ngMenuText: '阆告搰娆勪綅锛?,
		ngShowingItemsLabel: '鐩墠椤ず绛嗘暩锛?,
		ngTotalItemsLabel: '绺界瓎鏁革细',
		ngSelectedItemsLabel: '阆稿彇绛嗘暩锛?,
		ngPageSizeLabel: '姣忛爜椤ず锛?,
		ngPagerFirstTitle: '绗竴阕?,
		ngPagerNextTitle: '涓嬩竴阕?,
		ngPagerPrevTitle: '涓娄竴阕?,
		ngPagerLastTitle: '链€寰岄爜'
	};
