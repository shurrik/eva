...
describe('truncate', function () {
    ...
    describe('characters', function () {
        ...
        it('should trim these down', function () {
            expect(characterFilter('1234567890', 5)).toEqual('12345钬?);
        });

        it('should trim this down including the space', function () {
            expect(characterFilter('123456789 10 11 12 13 14', 13)).toEqual('123456789 10钬?);
        });

        it('should trim this down breaking on words', function () {
            expect(characterFilter('123456789 10 11 12 13 14', 14,true)).toEqual('123456789 10 1钬?);
        });

        it('should trim this down ignoring the space', function () {
            expect(characterFilter('Florida/New Jersey/California/Texas', 30, true)).toEqual('Florida/New Jersey/California/钬?);
        });
    ...
    describe('words', function () {
        ...
        it('should trim these down', function () {
            expect(wordFilter('abc def ghhi jkl mno pqr stu vw xyz', 5)).toEqual('abc def ghhi jkl mno钬?);
        });
